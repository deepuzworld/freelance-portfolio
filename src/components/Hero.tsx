        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-5">
              <Link 
                smooth
                to="/#portfolio" 
                className="bg-gray-900 border-2 border-gray-900 hover:bg-[#B89B72] hover:border-[#B89B72] text-white font-bold py-4 px-10 rounded-full transition-all text-center uppercase text-xs tracking-[0.3em] shadow-2xl"
              >
                View My Work
              </Link>
              <Link 
                smooth
                to="/#pricing" 
                className="border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white font-bold py-4 px-10 rounded-full transition-all text-center uppercase text-xs tracking-[0.3em]"
              >
                See Pricing
              </Link>
            </div>
          ...
          <div className="md:w-1/2 flex justify-center relative">
            <div className="relative w-full max-w-lg aspect-square flex items-center justify-center">
              ...
              <div className="relative w-[100%] h-[100%] overflow-hidden rounded-full border-[10px] border-white shadow-2xl bg-white/50 backdrop-blur-sm">
                <img 
                  src={heroImg} 
                  alt="Deepak Mathew" 
                  className="w-full h-full object-cover object-top scale-110 fade-in pt-8"
                />
              </div>

              <div className="absolute bottom-4 right-0 bg-white p-6 rounded-3xl shadow-2xl border border-gray-100 z-20">
                <div className="text-[#B89B72] font-black text-2xl tracking-tighter">5.0 Rating</div>
                <div className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-black mt-1">Direct Client Reviews</div>
              </div>
            </div>
          </div>
        </div>
